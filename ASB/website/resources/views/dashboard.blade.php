                        ...
                        <div class="post-container">
                            <div class="media mb-3">
                                <div class="media-left align-self-center user">
                                    <a href="pages-profile.html"><img src="{{asset('images/theme/avatar/avatar-07.jpg')}}" class="rounded-circle" alt="..."></a>
                                </div>
                            ...
                            <img src="{{asset('images/theme/background/01.jpg')}}" alt="..." class="img-fluid">
                ...
                <div class="widget widget-05 has-shadow">
                    ...
                    <div class="widget-body no-padding hidden">
                        <div class="author-avatar">
                            ...
                            <img src="{{asset('images/theme/avatar/avatar-03.jpg')}}" alt="..." class="img-fluid rounded-circle">
                        </div>
                        ...
                        <div id="list-group" class="widget-scroll" style="max-height:490px;">
                            <ul class="reviews list-group w-100">
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="media-left align-self-start">
                                            <img src="{{asset('images/theme/avatar/avatar-02.jpg')}}" class="user-img rounded-circle" alt="...">
                                        </div>
                                        <div class="media-body align-self-center">
                                            <div class="username">
                                                <h4>Brandon Smith</h4>
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="media-left align-self-start">
                                            <img src="{{asset('images/theme/avatar/avatar-05.jpg')}}" class="user-img rounded-circle" alt="...">
                                        </div>
                                        <div class="media-body align-self-center">
                                            <div class="username">
                                                <h4>Megan Duncan</h4>
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="media-left align-self-start">
                                            <img src="{{asset('images/theme/avatar/avatar-04.jpg')}}" class="user-img rounded-circle" alt="...">
                                        </div>
                                        <div class="media-body align-self-center">
                                            <div class="username">
                                                <h4>Nathan Hunter</h4>
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="media-left align-self-start">
                                            <img src="{{asset('images/theme/avatar/avatar-09.jpg')}}" class="user-img rounded-circle" alt="...">
                                        </div>
                                        <div class="media-body align-self-center">
                                            <div class="username">
                ...
                <div class="widget widget-11 has-shadow">
                    ...
                    <div class="widget-body p-0 widget-scroll" style="max-height:450px;">
                        ...
                        <div class="timeline violet">
                            <div class="timeline-content d-flex align-items-center">
                                <div class="user-image">
                                    <img class="rounded-circle" src="{{asset('images/theme/avatar/avatar-06.jpg')}}" alt="...">
                                </div>
                        ...
                        <div class="timeline violet">
                            <div class="timeline-content d-flex align-items-center">
                                <div class="user-image">
                                    <img class="rounded-circle" src="{{asset('images/theme/avatar/avatar-05.jpg')}}" alt="...">
                                </div>
                                <div class="d-flex flex-column mr-auto">
                                    <div class="title">
                                        ...
                                        <div class="users-like">
                                            <a href="profile.html">
                                                <img src="{{asset('images/theme/avatar/avatar-01.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                            <a href="profile.html">
                                                <img src="{{asset('images/theme/avatar/avatar-02.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                            <a href="profile.html">
                                                <img src="{{asset('images/theme/avatar/avatar-07.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                            <a href="profile.html">
                                                <img src="{{asset('images/theme/avatar/avatar-09.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex flex-column mr-auto">
                                    <div class="title">
                                        ...
                                        <div class="users-like">
                                            ...
                                            <a href="profile.html">
                                                <img src="{{asset('images/theme/avatar/avatar-06.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                            <a href="profile.html">
                                                <img src="{{asset('images/theme/avatar/avatar-03.jpg')}}" class="img-fluid rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="timeline violet">
                            <div class="timeline-content d-flex align-items-center">
                                <div class="user-image">
                                    <img class="rounded-circle" src="{{asset('images/theme/avatar/avatar-04.jpg')}}" alt="...">
                                </div>
                                <div class="d-flex flex-column mr-auto">
                                    <div class="title">
                        ...
                        <div class="timeline violet">
                            <div class="timeline-content d-flex align-items-center">
                                <div class="user-image">
                                    <img class="rounded-circle" src="{{asset('images/theme/avatar/avatar-03.jpg')}}" alt="...">
                                </div>
                                <div class="d-flex flex-column mr-auto">
                                    <div class="title">
                        ...
                        <div class="new-message">
                            <div class="media">
                                <div class="media-left align-self-center mr-3">
                                    <img src="{{asset('images/theme/avatar/avatar-04.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                </div>
                                <div class="media-body align-self-center">
                        ...
                        <ul class="list-group w-100 mt-5">
                            <li class="list-group-item">
                                <div class="other-message">
                                    <div class="media">
                                        <div class="media-left align-self-center mr-3">
                                            <img src="{{asset('images/theme/avatar/avatar-02.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                        </div>
                                        <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="other-message">
                                    <div class="media">
                                        <div class="media-left align-self-center mr-3">
                                            <img src="{{asset('images/theme/avatar/avatar-03.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                        </div>
                                        <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="other-message">
                                    <div class="media">
                                        <div class="media-left align-self-center mr-3">
                                            <img src="{{asset('images/theme/avatar/avatar-05.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 50px;">
                                        </div>
                                        <div class="media-body align-self-center">
                    ...
                    <div class="widget-body p-0">
                        ...
                        <ul class="list-group w-100 widget-scroll" style="max-height:250px;">
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{asset('images/theme/avatar/avatar-02.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{asset('images/theme/avatar/avatar-03.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{asset('images/theme/avatar/avatar-04.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{asset('images/theme/avatar/avatar-05.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{asset('images/theme/avatar/avatar-06.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{asset('images/theme/avatar/avatar-07.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{asset('images/theme/avatar/avatar-08.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                            ...
                            <li class="list-group-item">
                                <div class="media">
                                    <div class="media-left align-self-center mr-3">
                                        <img src="{{asset('images/theme/avatar/avatar-09.jpg')}}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                    </div>
                                    <div class="media-body align-self-center">
                                ...
                                <div class="widget20 owl-carousel">
                                    <div class="item">
                                        <div class="card-image">
                                            <img src="{{asset('images/theme/background/03.jpg')}}" alt="...">
                                    ...
                                    <div class="item">
                                        <div class="card-image">
                                            <img src="{{asset('images/theme/background/04.jpg')}}" alt="...">
                                    ...
                                    <div class="item">
                                        <div class="card-image">
                                            <img src="{{asset('images/theme/background/05.jpg')}}" alt="...">
                                            <div class="card-overlay card-overlay-01">
                                                <div class="card-overlay-content">
                                                    <div class="category">
                                                        <a href="#">Category</a>
                                    ...
                                    <div class="item">
                                        <div class="card-image">
                                            <img src="{{asset('images/theme/background/02.jpg')}}" alt="...">
                                            <div class="card-overlay card-overlay-02">
                                                <div class="card-overlay-content">
                                                    <div class="category">
                                                        <a href="#">Category</a>
...
@push('scripts')
    <script src="{{ asset('js/db-default-dark.js')}}"></script>
@endpush
