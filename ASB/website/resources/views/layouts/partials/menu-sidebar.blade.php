<div class="default-sidebar">
    ...
    <nav class="side-navbar box-scroll sidebar-scroll">
        ...
        <ul class="list-unstyled">
            <li class="{{$view_name=='dashboard'?'active':''}}"><a href="{{route('dashboard')}}"><i class="la la-columns"></i><span>@lang('menu.dashboard')</span></a></li>
            <li class="{{$view_name=='calendar'?'active':''}}"><a href="{{route('calendar')}}"><i class="la la-calendar"></i><span>@lang('menu.calendar')</span></a></li>
            {{--<li class="active"><a href="#dropdown-schedule" aria-expanded="true" data-toggle="collapse"><i class="la la-road"></i><span>Schedule</span></a>
                <ul id="dropdown-schedule" class="collapse list-unstyled show pt-0">
                    <li><a class="active" href="dashboard">Dashboard</a></li>
                    <li><a href="calendar">Calendar</a></li>
                </ul>
            </li>--}}
        </ul>
    {{--        <span class="heading">Theme Demo</span>--}}
