            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane show active fade" id="messenger" aria-labelledby="messenger-tab">
                    ...
                    <div class="messenger-message messenger-message-sender">
                        <img class="messenger-image messenger-image-default" src="{{asset('images/theme/avatar/avatar-02.jpg')}}" alt="...">
                    ...
                    <div class="messenger-message messenger-message-sender">
                        <img class="messenger-image messenger-image-default" src="{{asset('images/theme/avatar/avatar-05.jpg')}}" alt="...">
                        <div class="messenger-message-wrapper">
                            <div class="messenger-message-content">
                                <p>
